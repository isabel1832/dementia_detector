          ...
          <div className="w-full max-w-md">
            <div className="rounded-[2rem] border border-[#DCE3DD] bg-white p-7 shadow-sm sm:p-10">
              <div className="text-center">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[#EDF4EE] text-3xl">
                  👋
                </div>
              ...
              <form className="mt-8 space-y-6">
                ...
                <button
                  type="submit"
                  className="min-h-16 w-full rounded-2xl bg-[#315C43] px-6 text-lg font-bold text-white shadow-sm transition hover:bg-[#274C36] focus:outline-none focus:ring-4 focus:ring-[#B8CEBD]"
                >
                  Sign in
                </button>
              </form>
